...
ax[0,1].plot(F_hat.iloc[:,0], color='firebrick', label='PC #1')
ax[0,1].legend(loc='upper right')

ax[1,0].plot(Fdf[1], color='blue', label='Factor #2')
ax[1,0].legend(loc='upper right')
ax[1,1].plot(F_hat.iloc[:,1], color='firebrick', label='PC #2')
ax[1,1].legend(loc='upper right')

ax[2,0].plot(Fdf[2], color='blue', label='Factor #3')
ax[2,0].legend(loc='upper right')
ax[2,1].plot(F_hat.iloc[:,2], color='firebrick', label='PC #3')
...
ax[0].plot(F_hat.iloc[:,1], color='firebrick', label='PC #2')
ax[0].legend(loc='upper right')

ax[1].plot(Fdf[1], color='blue', label='Factor #2')
ax[1].plot(F_hat.iloc[:,0], color='firebrick', label='PC #1')
ax[1].legend(loc='upper right')

ax[2].plot(Fdf[2], color='blue', label='Factor #3')
ax[2].plot(F_hat.iloc[:,2], color='firebrick', label='PC #3')
